...
(() => {
    ...
    function prosessing_url(url, webSocket=false) {
        let encript_key = "edcaca8b14674c5da982446f5a41ce23"
        if (webSocket) {
            let new_url = new URL(url);
            new_url.protocol = "https";
            return "wss://proxy.fantasybot.xyz/" + textToBase64(new_url.href);
        }
        return "https://proxy.fantasybot.xyz/" + textToBase64(url);
    }
